...
void EKF::get_motion_jacobi(const hcState &state, const Control &control, double integration_step, Matrix3d &F_x,
                            Matrix32d &F_u) const
{
...
Matrix2d EKF::get_motion_covariance(const hcState &state, const Control &control, double integration_step) const
{
...
void EKF::predict(const hcState_With_Covariance &state, const Control &control, double integration_step,
...
void EKF::update(const hcState_With_Covariance &state_pred, hcState_With_Covariance &state_corr) const
{
