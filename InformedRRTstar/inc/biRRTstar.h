#ifndef OMPL_GEOMETRIC_PLANNERS_BIRRT_STAR
#define OMPL_GEOMETRIC_PLANNERS_BIRRT_STAR
...
namespace ompl
{
    namespace geometric
    {
        /** \brief Optimal bidirectional Rapidly-exploring Random Trees,
        Jordan, Matthew, and Alejandro Perez. "Optimal bidirectional rapidly-exploring random trees." (2013). */
        ...
        public:
            ...
            typedef std::function<void(std::vector<Motion *> tree, bool hc_tree)> tree_viz;
            typedef std::function<void(std::vector<steer::hcState> path, bool hc)> path_viz;
            typedef std::function<void(unsigned int iteration, double runtime, double sol_cost)> logging_info;
        ...
        private:
            ...
            sampleView sv_;
            tree_viz viz_tree_;
            path_viz viz_recent_path_;
            logging_info record_;
            add_node add_node_to_tree_;
            // HC00_Reeds_Shepp_State_Space hc_state_space_;
            // SReeds_Shepp_State_Space rs_state_space_;
            bool activate_viz_{false};
        ...
        // protected:
            ...
            std::pair<Motion *, Motion *>* bestConnectMotion_{nullptr};

            /** \brief A list of states in the tree that satisfy the goal condition */
            std::vector<std::pair<Motion *, Motion *>* > connectMotions_;
