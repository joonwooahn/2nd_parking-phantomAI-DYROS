...
//   Rotation_Matrix[0][0] = cos(YAW)*cos(PITCH);
//   Rotation_Matrix[0][1] = sin(YAW)*cos(PITCH);
//   Rotation_Matrix[0][2] = -sin(PITCH);
//   Rotation_Matrix[1][0] = cos(YAW)*sin(PITCH)*sin(ROLL)-sin(YAW)*cos(ROLL);
//   Rotation_Matrix[1][1] = sin(YAW)*sin(PITCH)*sin(ROLL)+cos(YAW)*cos(ROLL);
//   Rotation_Matrix[1][2] = cos(PITCH)*sin(ROLL);
//   Rotation_Matrix[2][0] = cos(YAW)*sin(PITCH)*cos(ROLL)+sin(YAW)*sin(ROLL);
//   Rotation_Matrix[2][1] = sin(YAW)*sin(PITCH)*cos(ROLL)-cos(YAW)*sin(ROLL);
...
// XY_coord InvProjGND(double X_W,double Y_W,double ROLL,double PITCH, double YAW, double World_CamX,double World_CamY,double World_CamZ, struct ocam_model *myocam_model,  const int& direction_mode)
// {
//   double a,b,c;
//   double World_vec[3];
//   double Cam_vec[3];
