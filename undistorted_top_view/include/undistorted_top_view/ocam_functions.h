...
#include <math.h>
// #include <cv.h> ///
#include <opencv2/imgproc/types_c.h> /// jw add
#include <opencv2/opencv.hpp> /// jw add
// #include <opencv/highgui.h>///
#include "opencv2/highgui/highgui.hpp" /// jw add
...
XY_coord ProjGND(int Ximg,int Yimg,double ROLL,double PITCH, double YAW, double World_CamX,double World_CamY,double World_CamZ, struct ocam_model *o);
XY_coord InvProjGND(double X_W,double Y_W,double ROLL,double PITCH, double YAW, double World_CamX,double World_CamY,double World_CamZ, struct ocam_model *o, const int& direction_mode);